...
int schema_attribute(sdlPtr *sdl, xmlAttrPtr tsn, xmlNodePtr attrType, sdlTypePtr cur_type)
{
	...
	attr = get_attribute(attrType->properties, "default");
	attr = get_attribute(attrType->properties, "fixed");
	attr = get_attribute(attrType->properties, "form");
	attr = get_attribute(attrType->properties, "id");
	attr = get_attribute(attrType->properties, "name");
	attr = get_attribute(attrType->properties, "ref");
	attr = get_attribute(attrType->properties, "type");
	attr = get_attribute(attrType->properties, "use");
	return TRUE;
}
